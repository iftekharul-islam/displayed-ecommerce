...
class CreatePermissionTables extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create($tableNames['permissions'], function (Blueprint $table) {
            ...
            $table->integer('code')->unique()->nullable(); //custom added
            $table->string('group')->nullable(); //custom added
            $table->string('label')->nullable(); //custom added
            $table->unsignedBigInteger('module_id')->nullable(); //custom added
            $table->timestamps();
