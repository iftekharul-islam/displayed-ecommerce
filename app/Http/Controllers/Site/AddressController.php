...
class AddressController extends Controller
{
    ...
    public function getDivisions($id, ShippingInterface $shipping): \Illuminate\Http\JsonResponse
    {
        try {
            $data = [
                'divisions' => $shipping->getDivisionByCountry($id),
            ];
            return response()->json($data);
        } catch (\Exception $e) {
            return response()->json([
    ...
    public function getDistricts($id, ShippingInterface $shipping): \Illuminate\Http\JsonResponse
    {
        try {
            $data = [
                'districts' => $shipping->getDistrictsByDivision($id),
            ];
            return response()->json($data);
        } catch (\Exception $e) {
            return response()->json([
