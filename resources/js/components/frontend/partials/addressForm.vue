          ...
          <form @submit.prevent="saveAddress()">
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label>Area</label>
                  <v-select :dir="settings.text_direction" label="name" :options="areas" v-model="form.area_id" :reduce="(option) => option.id" :class="{ 'error_border' : errors.area_id }"></v-select>
                </div>
                <span class="validation_error"
                      v-if="errors.area_id">{{ errors.area_id[0] }}</span>
              </div>
              <div class="col-md-6">
                <div class="form-group">
    ...
    getStates() {
      ...
      axios.get(url).then((response) => {
        ...
        if (response.data.error) {
          ...
          this.states = response.data.divisions;
        }
      });
    },
    getCities() {
